...
**Adresse IP** : Votre adresse IP est traitée lors de la visite de NeuraDAO Marketplace.
...
Lorsque vous visitez NeuraDAO Marketplace, votre adresse IP est traitée par Netlify, un fournisseur de services qui héberge notre marché. Netlify dessert notre marché en utilisant un Content Delivery Network (un réseau géographiquement distribué) avec des serveurs situés en dehors et à l&#39;intérieur de l&#39;Espace économique européen. Nous utilisons des clauses contractuelles types (CCT) pour fournir des garanties appropriées au traitement de vos données personnelles. Vous avez le droit de recevoir une copie des présentes CCT.
...
## 4.1 Fourniture de NeuraDAO Marketplace et création de fichiers journaux

Nous collectons et utilisons votre adresse IP pour fournir l&#39;accès à NeuraDAO Marketplace hébergé chez Netlify. De plus, Ocean utilise Netlify Analytics pour collecter et stocker votre adresse IP. Vos données personnelles ne quitteront jamais notre service et nous ne vous suivrons pas sur à travers d&#39;autres sites.

**Fins:**

La collecte et l&#39;utilisation de votre adresse IP sont nécessaires pour fournir l&#39;accès à NeuraDAO Marketplace, car il s&#39;agit d&#39;une exigence technique pour assurer la communication entre votre appareil et notre marché.

Ocean utilise Netlify Analytics pour distinguer les visiteurs uniques en fonction des adresses IP. Ce processus nous aide à mieux comprendre combien d&#39;utilisateurs visitent NeuraDAO Marketplace et dans quels pays se trouvent les utilisateurs. Nous utilisons ces informations pour mesurer les tendances du trafic et de la popularité afin d&#39;améliorer notre service.
...
Notre intérêt légitime est de vous fournir NeuraDAO Marketplace et ses fonctionnalités, ainsi que de les améliorer.
...
Nous devons traiter votre adresse de votre portefeuille pour lier votre publication à votre adresse. Nous traitons votre nom pour activer la fonctionnalité de recherche et de filtrage sur NeuraDAO Marketplace. La transaction contenant votre adresse de votre portefeuille et le nom de l&#39;auteur sera stockée en permanence sur la chaîne afin que vous puissiez prouver la propriété et la vente des actifs.
...
Lorsque vous avez publié un set de données, nous récupérons, organisons et stockons votre adresse de votre portefeuille et votre nom d&#39;auteur sur un cache de métadonnées géré par Ocean. De plus, nous montrons votre set données sur NeuraDAO Marketplace.

**Fins:**

La récupération de données à partir de la blockchain prend du temps. Par conséquent, nous récupérons, organisons et stockons vos données personnelles sur un cache pour améliorer les performances de NeuraDAO Marketplace. Nous montrons votre set de données sur NeuraDAO Marketplace, afin que les visiteurs puissent trouver, consommer et staker.
...
Notre intérêt légitime est d&#39;améliorer l&#39;expérience utilisateur en améliorant les performances de NeuraDAO Marketplace.
...
Lhistorique de NeuraDAO Marketplace est un outil de transparence que vous pouvez utiliser pour visualiser vos transactions relatives à NeuraDAO Marketplace. Lorsque vous utilisez l&#39;historique, nous collectons votre adresse de votre portefeuille. Ensuite, nous récupérons les transactions respectives et pertinentes stockées sur la blockchain (plus précisément, à partir du cache de métadonnées) et les organisons dans une table.

**Fins:**

Nous devons collecter votre adresse de votre portefeuille pour récupérer chaque transaction que vous avez effectuée sur NeuraDAO Marketplace. Nous récupérons et organisons vos données de transaction publiques afin que vous puissiez rapidement avoir un aperçu de toutes les actions que vous avez effectuées sur NeuraDAO Marketplace.
...
Notre intérêt légitime à fournir l&#39;historique est de vous offrir la possibilité de visualiser et avoir une vue d&#39;ensemble de vos transactions effectuées sur NeuraDAO Marketplace.
...
NeuraDAO Marketplace contient des liens vers des sites Web externes qui sont hors du contrôle et de la responsabilité de Ocean. Nous marquons les liens externes en utilisant ceci: &#8599;.
...
- Visitez votre actif publié sur NeuraDAO Marketplace ([market.oceanprotocol.com](https://market.oceanprotocol.com)).
...
Veuillez noter que vous devez payer des frais de gas (fees) pour la confirmation des changements (car une nouvelle transaction est émise). Après modification, la version précédente de vos métadonnées du set de données ne sera plus visible sur NeuraDAO Marketplace. En outre, vous pouvez modifier le contenu de votre set de données à tout moment.
...
Si vous avez publié un set de données, vous devez remplacer le nom d&#39;auteur fourni par un espace réservé en effectuant les étapes énumérées au chapitre 7.2. Si vous souhaitez désactiver l&#39;affichage de votre set de données sur NeuraDAO Marketplace, veuillez lire le chapitre 7.4.
