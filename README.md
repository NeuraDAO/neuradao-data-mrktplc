...
<h1 align="center">NeuraDAO Marketplace</h1>
...
- The name "NeuraDAO Marketplace" is also copyright protected and should be changed to the name of your market.
...
NeuraDAO Marketplace comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
